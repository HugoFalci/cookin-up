<script lang="ts">
import { obterCategorias } from '@/http/index'; // Importa a função para obter categorias
    ...
    <section class="selecionar-ingredientes">
        ...
        <ul class="categorias">
            ...
            <li v-for="categoria in categorias" :key="categoria.nome">
                <!-- Componente CardCategoria com eventos emitidos -->
...
<style scoped>
/* Estilo para a seção 'selecionar-ingredientes' */
...
.dica {
    ...
    margin-bottom: 3.5rem; /* Margem inferior */
}

/* Estilos responsivos para telas com largura máxima de 767px */
@media only screen and (max-width: 767px) {
    .dica {
        margin-bottom: 2.5rem; /* Ajusta a margem inferior */
    }
}
</style>